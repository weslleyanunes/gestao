...
CREATE TABLE `logs_sistema` (
  ...
  `entidade_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `acao` enum('Criar','Alterar','Deletar','Login') COLLATE utf8mb4_general_ci NOT NULL,
  `conteudo_old` text COLLATE utf8mb4_general_ci,
  `conteudo_new` text COLLATE utf8mb4_general_ci,
